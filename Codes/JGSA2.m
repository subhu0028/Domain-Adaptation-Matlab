pie05 = load('PIE29.mat');
pie07 = load('PIE27.mat');
Xs = pie05.fea;
Xt = pie07.fea;
Ys = pie05.gnd;
Yt = pie07.gnd;
...
Xs = Xs';
Xt = Xt';
Cls = knnclassification(Xt',Xs',Ys,1, '2norm');
Yt0 = Cls;
[Xs, Xt, A, Att] = JGSA(Xs, Xt, Ys, Yt0, Yt);


function [Xs, Xt, A, Att] = JGSA(Xs, Xt, Ys, Yt0, Yt)
...
% 		c = kpar(2);	% additive constant
        ...
        case 'rbf'
            ...
            K = exp(-gamma*D); 
            %K = @(X1,X2) exp(-sum((X1-X2).^2)./(2.*kpar.^2));
